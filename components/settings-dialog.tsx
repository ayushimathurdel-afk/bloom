...
export function SettingsDialog({ children, open: openProp, onOpenChange }: SettingsDialogProps) {
  ...
  async function handleExport() {
    ...
    try {
      ...
      // A user dismissing the native share sheet throws — treat that as a no-op.
      ...
      >
        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              When logging an exercise, pre-fill one reference set from your previous session. It&apos;s only a
              starting point — nothing is saved until you log it.
            </p>
          </div>
          ...
          <div className="flex items-start gap-2 rounded-lg border border-border bg-accent/40 p-3 text-sm text-accent-foreground">
